<template>
    <div class="svg-containter">
        ...
        <g id="rocket" fill="none" fill-rule="evenodd">			
          ...
          <text x="0" transform="rotate(-20 50 50)" y="130" fill="grey" font-size="0.9rem" font-weight="900" > 
            EverScale				
          </text>
          </g>
...
#cloud2 {
  -webkit-animation: fall-2 11s linear infinite;
          animation: fall-2 11s linear infinite;
}

#cloud3 {
  -webkit-animation: fall-3 13s linear infinite;
